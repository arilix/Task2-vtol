"""
Launch file untuk MAVROS Control Node (C++) - ROS 2 Foxy & Humble

Menjalankan mavros_control_node (C++) dengan opsi konfigurasi melalui launch arguments.
...
def generate_launch_description():
    ...
    # ---- MAVROS Control Node (C++) ----
    mavros_control_cpp_node = Node(
        package='drone_mission',
        executable='mavros_control_node',
        name='mavros_control',
        output='screen',
        parameters=[{
